	...
	<section class="bg0 p-t-50" method="post">
		<div class="container">
            <?php
                ...
                $sql = "SELECT * FROM order_master WHERE user_id = '$_SESSION[user_id]' ORDER BY order_id DESC";
                        ...
                        ?>
                            <div class="card mb-5">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-9 col-sm-12 col-md-9 mt-2">
                                            <a href="order-details.php?source=<?php echo $rowOrder['transaction_id'];?>">#<?php echo $rowOrder['transaction_id'];?></a>
                                        </div>
                                ...
                                <div class="card-footer">
									...
									<?php if($rowOrder['order_status']=='Order Cancelled'){
										echo "<h5 class='mt-2' style='color:red;'>Your Order has been cancelled</h5>";
									} else {
										?>
