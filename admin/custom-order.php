<?php
    ...
    if(isset($_POST['update'])){ 
        ...
        $update="UPDATE custom_order SET 
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid p-4">
                        <div class="row">
                            <div class="col-9">
                                <h3 class="mb-3">Manage Custom Orders</h1>
                            </div>
                        ...
                        <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                    <?php
                                        $resData = mysqli_query($conn, "SELECT om.order_id, om.order_number,om.order_status,om.order_date,um.user_name,
                                        um.user_phone_number, pm.* FROM custom_order om,user_master um, payment_master pm WHERE 
                                        om.user_id=um.user_id AND pm.transaction_id = om.order_number");
                                        if (mysqli_num_rows($resData) > 0) {
                                            ...
                                            while($rowData = mysqli_fetch_assoc($resData)) {
                                                ...
                                                echo "<tr>"; 
                                                echo "<th>".$count."</th>";
                                                echo "<td>#".$rowData['order_number']."</td>"; 
                                                ...
                                                ?>
                                                <form method="POST">
                                                    <a href="view-order-custom.php?source=<?php echo $rowData['order_number'];?>"><i class='fa fa-eye'></i></a> | 
