...
<html lang="en">
<head>
    <title>Search - <?php echo $site;?></title>
	<meta charset="UTF-8">
...
?>
    ...
    $sql = "SELECT * FROM product_master WHERE product_status = 'Active' AND product_name LIKE '%$source%'";
	...
	<section class="bg0 p-t-62">
		<div class="container">
					<div class="p-r-45 p-r-0-lg">
						<!-- item blog -->
						<div class="p-b-63">
                        <h3 class="ltext-103 cl5">Search result for ' <?php echo $source;?> '</h3>
                        ...
                        if(mysqli_num_rows($res2)>0){
                            ...
                            echo "<h5>No matching product found for ' $source '</h5>";
                        }              
                    ?>
			        </div>
                </div>
                    ...
                    <?php
                        for($i = 1; $i<= $number_of_page; $i++) {  
                            if($i <= $page+$number_of_page && $i >= $page){
                                ...
                                echo "<a href='?search=$source&page=$i' class='flex-c-m how-pagination1 trans-04 m-all-7";
                                if($page==$i){
