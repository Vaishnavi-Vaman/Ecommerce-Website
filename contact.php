...
<html lang="en">
<head>
    <title>Contact Us - <?php echo $site;?></title>
	<meta charset="UTF-8">
...
<body class="animsition">
	...
	<!-- Content page -->
	<section class="bg0 p-t-104 p-b-52">
		<div class="container">
			<div class="flex-w flex-tr">
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
                    <div class="map">
                        <div class="size-303" id="google_map" data-map-x="12.9141" data-map-y="74.8560" data-pin="images/icons/lpin.png" data-scrollwhell="0" data-draggable="1" data-zoom="11"></div>
                    </div>
				</div>
				...
				<div class="size-210 bor10 flex-w flex-col-m p-lr-93 p-tb-30 p-lr-15-lg w-full-md">
					<div class="flex-w w-full p-b-42">
						...
						<div class="size-212 p-t-2">
                            ...
                            57 Stellar Avenue, Cosmic Plaza, Nebula District, Galaxy ZR9-22, Universe 1P7C-3F6
							</p>
						</div>
					</div>
