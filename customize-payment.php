	...
	if (isset($_POST['payment'])) {
		...
		if (mysqli_query($conn, "UPDATE user_master SET user_name = '$_POST[name]', user_phone_number = '$_POST[number]', address_line_1 = '$_POST[add1]', 
			...
			if (mysqli_query($conn, "INSERT INTO payment_master (card_holder_name, card_number, card_expiry_date, card_expiry_month, card_cvv, 
					date_of_payment, payment_status, card_expiry_year, transaction_id, total_amount, payment_mode) VALUES ('$_POST[card_holder]', '$_POST[card_number]', '$_POST[card_date]', 
					'$_POST[card_month]', '$_POST[card_cvv]', NOW(), 'Success', '$_POST[card_year]', '$OrderId', '$_POST[credit]', '$_POST[type]')")) {

				if (mysqli_query($conn, "INSERT INTO material_temp (material_id, material_file, order_number) 
						VALUES ('$mid', '$mfile', '$OrderId')")) {

					if (mysqli_query($conn, "INSERT INTO custom_order (user_id, order_number, order_status, order_date) 
							VALUES ('$user_id', '$OrderId', 'Order Placed', NOW())")) {

						echo '<script>swal("Success", "Your order placed successfully !", "success").then(function() {
								window.location = "customize-orders.php";
							});</script>';
					} else {
				...
				<div class="row">
					<div class="col-lg-10 col-xl-7 m-lr-auto m-b-50">
						...
						<div class="row">
							<div class="col-12 px-5 pt-2">
								<div class="form-check">
									<input class="form-check-input" type="radio" name="type" id="flexRadioDefault1" value="cash">
									<label class="form-check-label" for="flexRadioDefault1">
										Cash on Delivery
									</label>
								</div>
								<div class="form-check">
									<input class="form-check-input" type="radio" name="type" id="flexRadioDefault2" checked value="card">
						...
						<div class="row">
							...
							<div class="col-6">
								...
								<div class="bor8 bg0 m-b-12">
									<input class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" placeholder="Card Number" name="card_number" required pattern="[0-9]{16}" title="Accept 16 digit numbers only." maxlength="16">
								</div>
							</div>
							<div class="col-3">
							...
							<div class="col-3">
								<p><small>CVV</small></p>
								<div class="bor8 bg0 m-b-12">
									<input class="stext-111 cl8 plh3 size-111 p-lr-15" type="password" placeholder="CVV Number" name="card_cvv" required pattern="[0-9]{3}" title="Accept 3 digit numbers only." maxlength="3">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
						<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
							...
							$res = mysqli_query($conn, "SELECT * FROM design_temp a, customize_category b 
								WHERE a.cc_id = b.cc_id AND a.order_number = '$OrderId'");
							...
							?>
											...
											<div class="flex-w flex-t bor12 p-b-13">
												...
												<div class="size-209">
													<span class="mtext-110 cl2">
														Rs. <?php echo number_format($resC['design_price'], 2); ?>
													</span>
												</div>
											</div>
										...
										<div class="flex-w flex-t bor12 p-b-13 ">
											...
											<div class="size-209">
												<span class="mtext-110 cl2">
													Rs. <?php echo number_format($row['default_price'], 2); ?>
												</span>
											</div>
										</div>
								...
								echo '<script>swal("Oops", "An invalid design selection !", "error").then(function() {
							...
							if (empty($mid)) {
								...
								$res = mysqli_query($conn, "SELECT * FROM material_master WHERE material_id = '$mid'");
								if (mysqli_num_rows($res) > 0) {
								...
								?>
									...
									<div class="flex-w flex-t bor12 p-b-13">
										...
										<div class="size-209">
											<span class="mtext-110 cl2">
												Rs. <?php echo number_format($mtPrice, 2); ?>
											</span>
										</div>
									</div>
							...
							<div class="flex-w flex-t p-t-27 p-b-33">
								...
								<div class="size-209 p-t-1">
									<span class="mtext-110 cl2">
										Rs. <?php echo number_format($tPrice, 2) ?>
									</span>
								</div>
							</div>

							<span>Would like to pay</span>
							<input type="number" name="credit" required class="form-control" min="1" value="<?php echo $tPrice;?>"/>
							<input type="hidden" name="topay" value="<?php echo $tPrice;?>"/>
							<br>
